...
namespace LunyScript.Test.Scripts
{
	...
	public sealed class ScriptFlowBlockTests
	{
		...
		private class MockCondition : ScriptConditionBlock
		{
			...
			protected internal override Boolean Evaluate(IScriptRuntimeContext runtimeContext) => _result;
		}
		...
		private class MockAction : ScriptActionBlock
		{
			...
			protected internal override void Execute(IScriptRuntimeContext runtimeContext) => _action();
		}
